...
public class StudentTest {
    ...
    //@Before setUp() method saves the sample details before each test method runs and to avoid repetition of initialising instances in each test method
    @Before
    public void setUp() {
    ...
    public void TestDeleteStudent() {
        ...
        String result = instance.DeleteStudent(idToDelete,true);
        assertEquals(expResult, result); //checks correct message returned after details have been deleted
        assertEquals("No student data to display!\n" + instance.CONTINUE,instance.StudentReport()); /*ensures that 
        there is no student details saved in the system */
    }
