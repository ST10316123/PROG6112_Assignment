...
public class ProgAssignFinalPartTwo {
    ...
    /*
    This program helps receptionist with managing appointments for a clinic.
        ...
        while (input.equalsIgnoreCase("y")) {
            ...
            switch (programChoice) {
                ...
                case "1" :
                    ...
                    if (!ap.getBookingTimes().isEmpty()) {  //Patients details can only be added when bookings are available
                    ...
                    while (!ap.isAgeNumeric(checkAge)) {
                        System.out.println(ap.ageNumericMessage(checkAge));
                    ...
                    while (!ap.chooseSex(checkSex)) {
                        System.out.println(ap.chooseSexMessage(checkSex));
                        System.out.println("Please enter your sex"
                            + "\n Enter \"M\" for male or \"F\" for female>>>");
                    ...
                    ap.savePatientDetails(name, patientSex, age, contact);
                    ContinueProgram();
                    }
                ...
                case "2": 
                    System.out.println(ap.bookingTimesAvailable()); //displays available booking times
                    ContinueProgram();
                    break;
                    
                case "3": 
                    System.out.println(ap.displayPatients());   //displays all patients that booked
                    ContinueProgram();
                    break;
                ...
                case "4":
                    ...
                    System.out.println(ap.deleteBooking(patientDelete)); //deletes booking for a patient
                    ContinueProgram();
                    break;
